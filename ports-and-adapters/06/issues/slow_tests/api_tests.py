...
def report_issue(reporter_name='fred', reporter_email='fred@example.org', problem_description='Halp!!!1!!1!11eleven!'):
    data = {
...
class When_reporting_a_new_issue:
    ...
    def because_we_report_a_new_issue(self):
        self.location = report_issue('Arnold', 'arnold@example.org', "I'm all alone and frightened.")
...
class When_assigning_an_issue_to_another_engineer:
    ...
    def because_barbara_assigns_the_issue_to_constance(self):
        self.response = requests.post(self.location + '/assign?engineer=constance',
